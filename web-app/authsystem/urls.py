...
from authsystem.views import RegisterView, LoginView, LogoutView, UserProfileSeeView, UserProfileEditView, \
    ...
    UserProfileDeleteView, UserPersonProfileSeeView
...
urlpatterns = [
    ...
    url(r'^person-profile/(?P<email>\w+|[\w.%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4})/$',
        UserPersonProfileSeeView.as_view(), name='profile_person'),
    ...
    url(r'^profile-edit/change-password/$', login_required(UserPasswordChangeView.as_view()),
